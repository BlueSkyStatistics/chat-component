                                                    ...
                                                    <div className="d-flex justify-content-between align-items-start">
                                                        <div className="flex-grow-1">
                                                            <div className="fw-semibold">
                                                                {model.name}
                                                                {model.external && (
                                                                    <i className="fas fa-globe ms-2 text-muted"
                                                                       title="External Model"></i>
                                                                )}
                                                            </div>
